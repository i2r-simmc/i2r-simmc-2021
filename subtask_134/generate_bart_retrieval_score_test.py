...
def eval_score_retrieval(model, args, test_dataset, data_collator, tokenizer, pad_token_id):
    os.makedirs(args.output_dir, exist_ok=True)
...
if __name__ == '__main__':
    ...
    # init dataset
    test_src_file = os.path.join(args.data_dir, "simmc2_dials_dstc10_teststd_src_retrieval_candidates.txt")
    test_tgt_file = os.path.join(args.data_dir, "simmc2_dials_dstc10_teststd_retrieval_candidates.txt")
