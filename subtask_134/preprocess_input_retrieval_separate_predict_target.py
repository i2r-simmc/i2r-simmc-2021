...
root directory of this source tree.
    ...
    DST model baseline.
"""
from utils.convert_retrieval_separate_predict_target import convert_json_to_flattened
import argparse
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--output_path_src_retrieval", help="output path to retrieval candidates",
    )
    parser.add_argument(
        "--output_path_ground_true", help="output path to retrieval candidates",
    )
    parser.add_argument(
        "--output_path_dialog_turn_id", help="output path to dialog_turn_id",
    )
    ...
    output_path_src_retrieval = args.output_path_src_retrieval
    output_path_ground_true = args.output_path_ground_true
    output_path_dialog_turn_id = args.output_path_dialog_turn_id
    ...
    convert_json_to_flattened(
        ...
        output_path_src_retrieval=output_path_src_retrieval,
        output_path_ground_true=output_path_ground_true,
        output_path_dialog_turn_id=output_path_dialog_turn_id
    )
