...
export PATH_DIR=data/preprocess/teststd

## Train split
python3 -m preprocess_input_teststd \
    --input_path_json="${PATH_DATA_DIR}"/simmc2_dials_dstc10_train.json \
    --output_path_predict="${PATH_DIR}"/simmc2_dials_dstc10_train_predict.txt \
    --output_path_target="${PATH_DIR}"/simmc2_dials_dstc10_train_target.txt \
    --len_context=2 \
