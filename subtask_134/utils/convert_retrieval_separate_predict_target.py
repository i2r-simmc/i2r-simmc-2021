			...
			# NOTE: Retrieval options w/ belief states is not implemented.
				...
				if format_retrieval_options:
					...
					for option_ind in turn_options["retrieval_candidates"]:
						...
						count_options += 1
					retrieval_groundtrue.append(
						[start_index_retrieval, start_index_retrieval + count_options, turn_options["gt_index"]])
					dialog_id_data["turn_info"].append(
						{"turn_id": turn_id, "flat_id": [start_index_retrieval, start_index_retrieval + count_options]})
