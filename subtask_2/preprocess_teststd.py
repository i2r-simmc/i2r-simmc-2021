...
if __name__ == '__main__':
    ...
    mode = args.mode
    train_file = './simmc2_data/simmc2_dials_dstc10_train.json'
    ...
    scene_folder = './simmc2_data/public'
    ...
    for dialog_i, dialog in enumerate(data):
        ...
        turn_num = len(dialog[FIELDNAME_DIALOG])
        current_turn_i = 0
        ...
        for turn in dialog[FIELDNAME_DIALOG]:
            ...
            # Only the last turn is the one needs to predict
            if current_turn_i != turn_num:
                continue
